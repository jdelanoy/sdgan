...
net_arg.add_argument('--zc_dim', type=int, default=64, choices=[50, 64, 128])
net_arg.add_argument('--zi_dim', type=int, default=64, choices=[50, 64, 128])
...
data_arg.add_argument('--ninstances', type=int, default=2)
